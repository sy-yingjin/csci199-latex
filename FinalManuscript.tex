...
\ThesisTitle{FROM POSTS TO VOTES: USING XLM-RoBERTa (XLM-R) TO ANALYZE SOCIAL MEDIA AS AN INDICATOR OF PRESIDENTIAL ELECTION\\WINS FOR THE PHILIPPINES AND UNITED STATES}
